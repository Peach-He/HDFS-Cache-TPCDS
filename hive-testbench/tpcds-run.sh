...
#perl runSuite.pl $QUERY_DIR $run_id presto parquet 1000
#perl runSuite.pl $QUERY_DIR $run_id hive parquet 1000
perl runSuite.pl $QUERY_DIR $run_id spark orc 1000
#perl runSuite.pl $QUERY_DIR $run_id spark text 512
...
#perl runSuite.pl $QUERY_DIR $run_id spark orc 10000
